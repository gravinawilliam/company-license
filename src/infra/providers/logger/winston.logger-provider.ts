    ...
    ISendLogTimeControllerLoggerProvider
{
  ...
  private readonly logsFolder: string = 'logs';
  ...
  constructor() {
    ...
    this.level = GLOBAL_CONFIG.IS_DEVELOPMENT ? LevelName.DEBUG : LevelName.INFO;
  ...
  public sendLogTimeController(
    ...
    this.logger.info(`${emoji.get('alarm_clock')} ${this.getValue(parameters.message)}`);
  }
